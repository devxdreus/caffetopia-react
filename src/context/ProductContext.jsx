    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                ...
                const data = response.data.payload.map((product) => {
    ...
    const deleteProduct = async (product) => {
        try {
            ...
            setProducts((prevProducts) =>
                prevProducts.filter((i) => i.id !== product.id)
            );
            return response;
        } catch (error) {
            console.error(error);
    ...
    const deleteCategory = async (category) => {
        try {
            ...
            setCategories((prevCategories) =>
                prevCategories.filter((i) => i.id !== category.id)
            );
            setProducts((prevProducts) =>
                prevProducts.filter((i) => i.category_id !== category.id)
            );
            return response;
        } catch (error) {
            console.error(error);
